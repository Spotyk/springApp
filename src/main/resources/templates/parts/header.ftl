...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light no-selectable">
        <a class="navbar-brand" href="/">
            <img src="/static/image/brand/brand.svg" width="30" height="30" class="d-inline-block align-top"
                 alt="brand">
        </a>
        ...
        <div class="left-flex-container">
            <div>${email}</div>
            <#if name == "guest">
                <div class="nav-link"><a class="btn btn-primary" href="/registration"><@spring.message "register"/></a>
                </div>
            ...
            <#if role?? && role?seq_contains("ADMIN")>
                <div class="nav-link"><a class="btn btn-primary" href="/adminPanel"><@spring.message "adminPanel"/></a>
                </div>
            </#if>
            <#if role?? && role?seq_contains("MANAGER")>
                <div class="nav-link"><a class="btn btn-primary"
                                         href="/adminPanel"><@spring.message "managerPanel"/></a></div>
            </#if>
        </div>
    </nav>
</header>
