    ...
    <div class="reg-form-position-left no-selectable">
        ...
        <form method="POST" enctype="multipart/form-data" id="fileUploadForm">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <button class="btn btn-outline-secondary changeable" type="button" onclick="makeAble(event)">
                        Change
                    </button>
                </div>
            </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-describedby="active-addon" name="username" disabled
                   value="${name}">
            <div class="input-group-append">
                <button class="btn btn-outline-secondary changeable" type="button" onclick="makeAble(event)">Change
                </button>
            </div>
        </div>
